...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = { 0xCCCCCCFF, 0x121212FF, 0x4A4A4AFF },
    [SchemeSel]  = { 0xDDDDDDFF, 0x2A2A2AFF, 0x1BFD9CFF },
    [SchemeUrg]  = { 0xFFFFFFFF, 0xBA0959FF, 0xBA0959FF },
};
...
static const char *mic_toggle[]      = {"control", "mic", "toggle", NULL};
static const char *brightness_up[]   = {"control", "brightness", "up", NULL};
static const char *brightness_down[] = {"control", "brightness", "down", NULL};
